...
const file_service_2_proto_rawDesc = "" +
	"\n" +
	"\x0fservice_2.proto\x12\tservice_2\"'\n" +
	"\vEchoRequest\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"(\n" +
	"\fEchoResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2A\n" +
	"\x04Echo\x129\n" +
	"\x04Echo\x12\x16.service_2.EchoRequest\x1a\x17.service_2.EchoResponse\"\x00B\rZ\v/service2pbb\x06proto3"

var (
	file_service_2_proto_rawDescOnce sync.Once
	file_service_2_proto_rawDescData []byte
)

func file_service_2_proto_rawDescGZIP() []byte {
	file_service_2_proto_rawDescOnce.Do(func() {
		file_service_2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_service_2_proto_rawDesc), len(file_service_2_proto_rawDesc)))
	})
	return file_service_2_proto_rawDescData
}

var file_service_2_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_service_2_proto_goTypes = []any{
	(*EchoRequest)(nil),  // 0: service_2.EchoRequest
	(*EchoResponse)(nil), // 1: service_2.EchoResponse
}
var file_service_2_proto_depIdxs = []int32{
	0, // 0: service_2.Echo.Echo:input_type -> service_2.EchoRequest
	1, // 1: service_2.Echo.Echo:output_type -> service_2.EchoResponse
...
func file_service_2_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_service_2_proto_rawDesc), len(file_service_2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
